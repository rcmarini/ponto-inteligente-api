...
import com.rmarini.pontointeligente.api.dtos.CadastroPFDto;
...
public class CadastroPFController {
	...
	private Funcionario converterDtoParaFuncionario(CadastroPFDto cadastroPFDto, BindingResult result)
		...
		cadastroPFDto.getQtdHorasAlmoco()
				.ifPresent(qtdHorasAlmoco -> funcionario.setQtdHorasAlmoco(new Float(qtdHorasAlmoco)));
		cadastroPFDto.getQtdHorasTrabalhoDia()
				.ifPresent(qtdHorasTrabalhoDia -> funcionario.setQtdHorasTrabalhoDia(new Float(qtdHorasTrabalhoDia)));
	...
	private CadastroPFDto converterCadastroPFDto(Funcionario funcionario) {
		...
		funcionario.getQtdHorasAlmocoOpt()
				.ifPresent(qtdHorasAlmoco -> cadastroPFDto.setQtdHorasAlmoco(Optional.of(qtdHorasAlmoco.toString())));
		funcionario.getQtdHorasTrabalhoDiaOpt().ifPresent(qtdHorasTrabalhoDia -> cadastroPFDto
				.setQtdHorasTrabalhoDia(Optional.of(qtdHorasTrabalhoDia.toString())));
